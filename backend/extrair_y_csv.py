...
df = pd.read_csv(r'C:\Users\leonardo.romariz\Documents\addicted-V1.2\Projetinho\backend\MachineLearning\data\students_social_media_addiction_processed.csv')
...
new_df.to_csv(r'C:\Users\leonardo.romariz\Documents\addicted-V1.2\Projetinho\backend\MachineLearning\data\y_test_dataset_addicted.csv', index=False)
...
# Salvar o novo DataFrame em um arquivo CSV
df_sem_addicted_score.to_csv(r'C:\Users\leonardo.romariz\Documents\addicted-V1.2\Projetinho\backend\MachineLearning\data\X_test_dataset_addicted_.csv', index=False)
